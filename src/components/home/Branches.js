...
const coverStyle = 'bg-[image:var(--image-url)] bg-cover bg-center h-20 md:w-[18em] md:h-36 lg:h-[14.375em]'
const descriptionBoxStyle = 'p-1 md:pb-2 lg:px-2.5 lg:pb-4'
