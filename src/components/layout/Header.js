...
// styles
const headerStyle= "container max-w-[1224px] mx-auto flex justify-between items-center h-[4em] md:h-[7.188em] px-[1.25em] bg-white"
const ulStyle = "flex items-center gap-x-[1.5em]";
const liStyle = "text-[#717171] text-sm lg:text-lg hover:font-bold border-b py-1 border-[#ffffff00] hover:text-[#417F56] hover:border-[#417F56] duration-500 cursor-pointer";
const buttonBoxStyle = "flex items-center gap-x-[0.25em] md:gap-x-[0.5em] justify-end"
