...
const mobileMenu = "absolute top-0 right-0 z-10 w-[12em] sm:w-[16em] duration-700";
const closeIconStyle = "absolute top-[18px] right-[9.5em] sm:right-[13.5em] text-white";
