...
// styles
const footerStyle = "bg-[image:var(--image-url)] bg-cover bg-center md:w-full text-white";
const containerStyle = "container max-w-[1224px] mx-auto flex items-center md:items-start justify-start lg:justify-between gap-x-[5.063em] py-[1.375em] md:pt-[2.031em] px-[1.25em] h-[9.5em] md:h-[19.938em]";
const ulStyle = "flex flex-col gap-y-[0.5em] md:gap-y-[1em] pr-[0.5em] md:pr-[1em]";
const liStyle = "text-[10px] md:text-base md:font-medium md:text-[#EDEDED]";
const h4Style =  "mb-[0.5em] md:mb-[1em] text-[14px] font-medium md:text-xl md:font-bold";
const iconBoxStyle = "items-center gap-x-[0.5em] md:gap-x-[1em]";
const inputBoxStyle = "flex flex-col gap-y-[0.75em]";
const inputStyle = "h-[2.5em] px-[1em] bg-transparent text-[#F9F9F9] placeholder:text-[#F9F9F9] outline-none border border-[#717171] rounded";
const buttonStyle = "text-[#F9F9F9] font-medium w-[11.438em] h-[2.5em] border border-[#717171] rounded";
