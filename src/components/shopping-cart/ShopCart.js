...
const cartDivStyle =
  "[&>*:nth-child(odd)]:bg-[#F9F9F9] [&>*:nth-child(even)]:bg-[#EDEDED] h-[187px] overflow-scroll mb-3 md:[&>*:nth-child(odd)]:bg-[#fff] md:[&>*:nth-child(even)]:bg-[#fff] md:border md:border-[#CBCBCB] md:rounded-lg md:p-6 md:h-[400px] md:w-full lg:h-[565px]";
